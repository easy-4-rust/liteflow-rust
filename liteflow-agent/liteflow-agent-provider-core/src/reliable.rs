...
//
// 本文件衍生自 ZeroClaw 项目 src/providers/reliable.rs。
// 修改：import 路径 super:: -> crate::；sanitize_api_error 改用 crate::util。
...
fn compact_error_detail(err: &anyhow::Error) -> String {
    crate::util::sanitize_api_error(&err.to_string())
        .split_whitespace()
        .collect::<Vec<_>>()
        .join(" ")
}
...
impl Provider for ReliableProvider {
    ...
    fn stream_chat_with_system(
        ...
        stream::once(async move {
            Err(crate::traits::StreamError::Provider(
...
mod tests {
    ...
    async fn chat_delegates_to_inner_provider() {
        let calls = Arc::new(AtomicUsize::new(0));
        let tool_call = crate::traits::ToolCall {
            id: "call_1".to_string(),
